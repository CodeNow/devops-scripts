...
for APP in agreeable-egret api arithmancy big-poppa clio cream datadog detention docker-listener drake eru github-varnish ingress-proxy khronos link mongo navi-proxy navi optimus palantiri pheidi prometheus-alerts prometheus sauron swarm-manager; do
