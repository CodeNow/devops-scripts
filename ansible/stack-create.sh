...
for APP in agreeable-egret api arithmancy big-poppa clio cream detention docker-listener drake eru github-varnish ingress-proxy khronos link mongo-navi navi-proxy navi optimus palantiri pheidi prometheus-alerts prometheus rabbitmq redis registry sauron swarm-manager; do
